...
Title.TextSize = 18
Title.Text = "Macaco Yield v" .. currentVersion
...
addcmd('aimbot',{'aim'},function(args, speaker)
	notify("Loading",'Hold on a sec')
	-- Full credit to exx, creator of SimpleSpy
	-- also thanks to NoobSploit for fixing
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		local versionJson = game:HttpGet('https://raw.githubusercontent.com/MARCOPABLO2015/Proyect/main/version?token=GHSAT0AAAAAAB5GJROWUNAT7WKIGXGC5WW2Y52K7HQ')
